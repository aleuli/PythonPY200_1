...
class MyTestCase(unittest.TestCase):  # TODO наследоваться от unittest.TestCase
    ...
    def test_repr_node_without_next(self):
        ...
        node = Node(5)
        exprected_repr = "Node(5, None)"
        self.assertEqual(exprected_repr, repr(node))
    ...
    def test_repr_node_with_next(self):
        ...
        node = Node(5, Node(10))
        exprected_repr = f"Node(5, Node(10))"
